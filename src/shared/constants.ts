...
// Note: library/community voices (like "Custom") require a PAID ElevenLabs plan
// via API — they return HTTP 402 on free accounts. Premade voices work on free.
export const DEFAULT_VOICE_ID = 'lxYfHSkYm1EzQzGhdbfc';

export const VOICE_OPTIONS = [
  { id: 'lxYfHSkYm1EzQzGhdbfc', name: 'Custom', description: 'Custom voice (paid plan)' },
...
export const STORAGE_KEYS = {
  SETTINGS: 'domino-settings',
  SETUP_COMPLETE: 'domino-setup-complete',
  MIC_GRANTED: 'domino-mic-granted',
  API_KEYS: 'domino-api-keys',
} as const;
