...
const Popup: React.FC = () => {
  ...
  const shortcutDisplay =
    settings?.shortcutKey === ' ' ? 'Space' :
    settings?.shortcutKey === '`' ? 'Backtick (`)' :
    ...
    <div style={styles.root}>
      ...
      <div style={styles.glass}>
        <div style={styles.header}>
          ...
          <div>
            <h1 style={styles.title}>DOM<span style={{ color: '#ffb020' }}>ino</span></h1>
            <p style={styles.tagline}>Say it. Watch it fall into place.</p>
          </div>
        </div>

        <p style={styles.nameNote}>
          <b style={{ color: '#ffb020' }}>DOM</b>, the page structure it operates on. <b style={{ color: '#ffb020' }}>Domino</b>, one command topples a chain of actions.
        </p>
