...
export async function sendTask(
  ...
  console.log('[DOMino][backend-client] sendTask called — command:', command);
  ...
  console.log('[DOMino][backend-client] /task response status:', response.status);
  ...
  if (!response.ok) {
    ...
    console.error('[DOMino][backend-client] /task error:', detail);
  ...
  console.log('[DOMino][backend-client] Task result type:', result.type);
  return result;
}
...
export async function sendTaskContinue(
  ...
  console.log('[DOMino][backend-client] sendTaskContinue called — command:', originalCommand, 'history length:', actionHistory.length);
  ...
  console.log('[DOMino][backend-client] /task/continue response status:', response.status);
  ...
  if (!response.ok) {
    ...
    console.error('[DOMino][backend-client] /task/continue error:', detail);
  ...
  const result = await response.json();
  console.log('[DOMino][backend-client] Continue result type:', result.type);
  return result;
}
